...
local array = loadstring(game:HttpGet("https://raw.githubusercontent.com/eLeCtRaDoMiNuS/githubfan3758329373475293859785728482/main/ArrayList.lua"))()
local lib = {
    ["Rainbow"] = false,
    ["Notifications"] = false,
    ["Sounds"] = true,
...
print("Loaded, press Right-Shift to toggle GUI")
...
function lib:CreateWindow()
    ...
    function lib:CreateTab(title, color, asset)
        ...
        assetthing.Image = getcustomassetfunc("" .. asset .. ".png") or getasset("" .. asset .. ".png")
        local tabtable = {
            ["Toggles"]={}
        }
